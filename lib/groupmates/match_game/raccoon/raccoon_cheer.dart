...
import '../screens/game_level2_screen.dart';
import '../settings_page.dart';
import '../services/coin_manager.dart';

class RaccoonCheerPage extends StatefulWidget {
  const RaccoonCheerPage({super.key});

  @override
  State<RaccoonCheerPage> createState() => _RaccoonCheerPageState();
}

class _RaccoonCheerPageState extends State<RaccoonCheerPage>
  ...
  Future<void> _onRaccoonTap() async {
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => const GameLevel2Screen(),
