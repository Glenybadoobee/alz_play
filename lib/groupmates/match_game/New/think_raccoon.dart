...
class ThinkPage extends StatefulWidget {
  ...
  @override
  State<ThinkPage> createState() => _ThinkPageState();
}
                  ...
                  children: [
                    ...
                    FadeTransition(
                      ...
                      child: Container(
                        ...
                        child: const Text(
                          'Are you secretly training to beat me?',
                    ...
                    SizedBox(
                      height: 100,
                      child: Image.asset(
                        'assets/match_game/folder9/raccoon5.png',
                        fit: BoxFit.contain,
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const HappyRaccoonPage()),
                        );
                      },
                      child: const Text(
                        'Continue',
