...
class _Level7ScreenState extends State<Level7Screen> {
  ...
  final correctAnswer = 'Monkey';
  final List<String> options = ['Monkey', 'Rhino', 'Lion', 'Fox', 'Human'];
  ...
  void checkAnswer(String answer) async {
    ...
    Future.delayed(const Duration(seconds: 1), () async {
      ...
      if (answer == correctAnswer) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const Level8Screen()),
        );
      } else {
        setState(() {
          selectedAnswer = '';
