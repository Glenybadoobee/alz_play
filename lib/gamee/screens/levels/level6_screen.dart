...
class _Level6ScreenState extends State<Level6Screen> {
  ...
  final correctAnswer = 'Dog';
  final List<String> options = ['Bear', 'Bird', 'Dog', 'Zebra', 'Tiger'];
  ...
  void checkAnswer(String answer) async {
    ...
    Future.delayed(const Duration(seconds: 1), () async {
      ...
      if (answer == correctAnswer) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const Level7Screen()),
        );
      } else {
        setState(() {
          selectedAnswer = '';
