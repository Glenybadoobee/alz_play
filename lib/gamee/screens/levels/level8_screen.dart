...
import '../gift_coins_flow/gift_coins.dart';
...
class _Level8ScreenState extends State<Level8Screen> {
  ...
  final correctAnswer = 'Bread';
  final List<String> options = ['Peanut', 'Pizza', 'Bread', 'Burger', 'Cake'];
  ...
  void checkAnswer(String answer) async {
    ...
    Future.delayed(const Duration(seconds: 1), () async {
      ...
      if (answer == correctAnswer) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const GiftCoins()),
        );
      } else {
        setState(() {
          selectedAnswer = '';
