...
class _SettingsPanelState extends State<SettingsPanel> {
  ...
  //gray box and sliders
  Widget _buildBluePanel(BuildContext context) {
    return Container(
  ...
  Widget _buildInnerBox(BuildContext context) {
    return Container(
